			...
			<div className="grid justify-items-center">
				<div className="grid grid-cols-7 mb-4 w-full">
					<div className=" col-span-3 justify-self-end grid-rows-2 justify-items-center">
						...
						<div className="justify-content-center text-align-center font-bold text-2xl">{game.awayScore}</div>
					</div>
					...
					<div className=" col-span-3 justify-self-start grid-rows-2 justify-items-center">
						...
						<div className="justify-content-center text-align-center font-bold text-2xl">{game.homeScore}</div>
					</div>
				</div>
				...
				<div className="grid grid-cols-2 lg:grid-cols-3 mb-4 w-full">
					<div className="justify-self-center text-xl  self-center">
						{getWeatherIcon(game.weatherConditions)}
					</div>
					<div className="justify-self-center self-center">
						<StatCard title={"Attendees"} value={game.attendance} />
					</div>
					<div className="grid grid-cols-1 justify-items-center mt-4 col-span-2 lg:col-span-1">
